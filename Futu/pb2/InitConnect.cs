...
namespace InitConnect {
  ...
  public static partial class InitConnect {
    ...
    internal static pbd::MessageDescriptor internal__static_InitConnect_C2S__Descriptor;
    internal static pb::FieldAccess.FieldAccessorTable<global::InitConnect.C2S, global::InitConnect.C2S.Builder> internal__static_InitConnect_C2S__FieldAccessorTable;
    internal static pbd::MessageDescriptor internal__static_InitConnect_S2C__Descriptor;
    internal static pb::FieldAccess.FieldAccessorTable<global::InitConnect.S2C, global::InitConnect.S2C.Builder> internal__static_InitConnect_S2C__FieldAccessorTable;
    internal static pbd::MessageDescriptor internal__static_InitConnect_Request__Descriptor;
    internal static pb::FieldAccess.FieldAccessorTable<global::InitConnect.Request, global::InitConnect.Request.Builder> internal__static_InitConnect_Request__FieldAccessorTable;
    internal static pbd::MessageDescriptor internal__static_InitConnect_Response__Descriptor;
    internal static pb::FieldAccess.FieldAccessorTable<global::InitConnect.Response, global::InitConnect.Response.Builder> internal__static_InitConnect_Response__FieldAccessorTable;
    #endregion
    #region Descriptor
    ...
    static InitConnect() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byI+CgNDMlMSEQoJY2xpZW50VmVyGAEgAigFEhAKCGNsaWVudElEGAIgAigJ", 
            "EhIKCnJlY3ZOb3RpZnkYAyABKAgibAoDUzJDEhEKCXNlcnZlclZlchgBIAIo", 
            "BRITCgtsb2dpblVzZXJJRBgCIAIoBBIOCgZjb25uSUQYAyACKAQSEgoKY29u", 
            "bkFFU0tleRgEIAIoCRIZChFrZWVwQWxpdmVJbnRlcnZhbBgFIAIoBSIoCgdS", 
            "ZXF1ZXN0Eh0KA2MycxgBIAIoCzIQLkluaXRDb25uZWN0LkMyUyJhCghSZXNw", 
            "b25zZRIVCgdyZXRUeXBlGAEgAigFOgQtNDAwEg4KBnJldE1zZxgCIAEoCRIP", 
            "CgdlcnJDb2RlGAMgASgFEh0KA3MyYxgEIAEoCzIQLkluaXRDb25uZWN0LlMy", 
          "Qw=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_InitConnect_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::InitConnect.C2S, global::InitConnect.C2S.Builder>(internal__static_InitConnect_C2S__Descriptor,
                new string[] { "ClientVer", "ClientID", "RecvNotify", });
        ...
        internal__static_InitConnect_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::InitConnect.S2C, global::InitConnect.S2C.Builder>(internal__static_InitConnect_S2C__Descriptor,
                new string[] { "ServerVer", "LoginUserID", "ConnID", "ConnAESKey", "KeepAliveInterval", });
        ...
        internal__static_InitConnect_Request__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::InitConnect.Request, global::InitConnect.Request.Builder>(internal__static_InitConnect_Request__Descriptor,
                new string[] { "C2S", });
        ...
        internal__static_InitConnect_Response__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::InitConnect.Response, global::InitConnect.Response.Builder>(internal__static_InitConnect_Response__Descriptor,
  ...
  public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
    ...
    private static readonly string[] _c2SFieldNames = new string[] { "clientID", "clientVer", "recvNotify" };
    private static readonly uint[] _c2SFieldTags = new uint[] { 18, 8, 24 };
    ...
    public static pbd::MessageDescriptor Descriptor {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_C2S__Descriptor; }
    }

    protected override pb::FieldAccess.FieldAccessorTable<C2S, C2S.Builder> InternalFieldAccessors {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_C2S__FieldAccessorTable; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasRecvNotify) {
        output.WriteBool(3, field_names[2], RecvNotify);
      }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<C2S, Builder> {
      ...
      public override pbd::MessageDescriptor DescriptorForType {
        get { return global::InitConnect.C2S.Descriptor; }
      }

      public override C2S DefaultInstanceForType {
        get { return global::InitConnect.C2S.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(C2S other) {
        if (other == global::InitConnect.C2S.DefaultInstance) return this;
        PrepareBuilder();
    ...
    static C2S() {
      object.ReferenceEquals(global::InitConnect.InitConnect.Descriptor, null);
    }
  }
  ...
  public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
    ...
    private static readonly string[] _s2CFieldNames = new string[] { "connAESKey", "connID", "keepAliveInterval", "loginUserID", "serverVer" };
    private static readonly uint[] _s2CFieldTags = new uint[] { 34, 24, 40, 16, 8 };
    ...
    public static pbd::MessageDescriptor Descriptor {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_S2C__Descriptor; }
    }

    protected override pb::FieldAccess.FieldAccessorTable<S2C, S2C.Builder> InternalFieldAccessors {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_S2C__FieldAccessorTable; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasServerVer) {
        output.WriteInt32(1, field_names[4], ServerVer);
      }
      if (hasLoginUserID) {
        output.WriteUInt64(2, field_names[3], LoginUserID);
      }
      if (hasConnID) {
        output.WriteUInt64(3, field_names[1], ConnID);
      }
      if (hasConnAESKey) {
        output.WriteString(4, field_names[0], ConnAESKey);
      }
      if (hasKeepAliveInterval) {
        output.WriteInt32(5, field_names[2], KeepAliveInterval);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<S2C, Builder> {
      ...
      public override pbd::MessageDescriptor DescriptorForType {
        get { return global::InitConnect.S2C.Descriptor; }
      }

      public override S2C DefaultInstanceForType {
        get { return global::InitConnect.S2C.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(S2C other) {
        if (other == global::InitConnect.S2C.DefaultInstance) return this;
        PrepareBuilder();
  ...
  public sealed partial class Request : pb::GeneratedMessage<Request, Request.Builder> {
    ...
    public static pbd::MessageDescriptor Descriptor {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_Request__Descriptor; }
    }

    protected override pb::FieldAccess.FieldAccessorTable<Request, Request.Builder> InternalFieldAccessors {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_Request__FieldAccessorTable; }
    }
    ...
    public global::InitConnect.C2S C2S {
      get { return c2S_ ?? global::InitConnect.C2S.DefaultInstance; }
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<Request, Builder> {
      ...
      public override pbd::MessageDescriptor DescriptorForType {
        get { return global::InitConnect.Request.Descriptor; }
      }

      public override Request DefaultInstanceForType {
        get { return global::InitConnect.Request.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(Request other) {
        if (other == global::InitConnect.Request.DefaultInstance) return this;
        PrepareBuilder();
        if (other.HasC2S) {
          MergeC2S(other.C2S);
        }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 10: {
              global::InitConnect.C2S.Builder subBuilder = global::InitConnect.C2S.CreateBuilder();
              if (result.hasC2S) {
      ...
      public Builder SetC2S(global::InitConnect.C2S value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.hasC2S = true;
        result.c2S_ = value;
      ...
      public Builder SetC2S(global::InitConnect.C2S.Builder builderForValue) {
      ...
      public Builder MergeC2S(global::InitConnect.C2S value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        if (result.hasC2S &&
            result.c2S_ != global::InitConnect.C2S.DefaultInstance) {
            result.c2S_ = global::InitConnect.C2S.CreateBuilder(result.c2S_).MergeFrom(value).BuildPartial();
        } else {
          result.c2S_ = value;
        }
        result.hasC2S = true;
  ...
  public sealed partial class Response : pb::GeneratedMessage<Response, Response.Builder> {
    ...
    public static pbd::MessageDescriptor Descriptor {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_Response__Descriptor; }
    }

    protected override pb::FieldAccess.FieldAccessorTable<Response, Response.Builder> InternalFieldAccessors {
      get { return global::InitConnect.InitConnect.internal__static_InitConnect_Response__FieldAccessorTable; }
    }
    ...
    public global::InitConnect.S2C S2C {
      get { return s2C_ ?? global::InitConnect.S2C.DefaultInstance; }
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<Response, Builder> {
      ...
      public override pbd::MessageDescriptor DescriptorForType {
        get { return global::InitConnect.Response.Descriptor; }
      }

      public override Response DefaultInstanceForType {
        get { return global::InitConnect.Response.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(Response other) {
        if (other == global::InitConnect.Response.DefaultInstance) return this;
        PrepareBuilder();
        if (other.HasRetType) {
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 34: {
              global::InitConnect.S2C.Builder subBuilder = global::InitConnect.S2C.CreateBuilder();
              if (result.hasS2C) {
      ...
      public Builder SetS2C(global::InitConnect.S2C value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.hasS2C = true;
        result.s2C_ = value;
      ...
      public Builder SetS2C(global::InitConnect.S2C.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.hasS2C = true;
      ...
      public Builder MergeS2C(global::InitConnect.S2C value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        if (result.hasS2C &&
            result.s2C_ != global::InitConnect.S2C.DefaultInstance) {
            result.s2C_ = global::InitConnect.S2C.CreateBuilder(result.s2C_).MergeFrom(value).BuildPartial();
        } else {
          result.s2C_ = value;
        }
        result.hasS2C = true;
