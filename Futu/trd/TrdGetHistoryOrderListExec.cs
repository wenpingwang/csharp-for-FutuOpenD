...
namespace Futu
{
    class TrdGetHistoryOrderListExec : IExecutor
    {
        ...
        private Trd_GetHistoryOrderList.Response response;

        public static int nProtoID = 2221;
        ...
        {
            response = Trd_GetHistoryOrderList.Response.ParseFrom(pack.Bodys);
        }
